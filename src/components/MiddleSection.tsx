...
export default function MiddleSection({ title, description, list, image, button }: Props) {
    return (
        <div className="min-h-screen bg-linear-90 from-neutral-300 to-gray-100 w-full p-8 grid grid-cols-1 lg:grid-cols-2 justify-center items-center gap-4">
            <img src={image} className="max-h-fit rounded-xl" />
